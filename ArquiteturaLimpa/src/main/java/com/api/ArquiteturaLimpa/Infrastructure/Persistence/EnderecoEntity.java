...
public class EnderecoEntity {
	...
	public EnderecoEntity( String numero, String rua, String bairro, String complemento, String estado,
			String cep) {
		this.numero = numero;
		this.rua = rua;
		this.bairro = bairro;
	...
	public EnderecoEntity(long id, String numero, String rua, String bairro, String complemento, String estado,
			String cep) {
		this.id = id;
		this.numero = numero;
		this.rua = rua;
